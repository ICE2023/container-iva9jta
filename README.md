...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-iva9jta.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-iva9jta.containers.anotherwebservice.com/
...
```
git clone git@github.com:ICE2023/container-iva9jta.git
cd container-iva9jta
```
...
```
docker attach container-iva9jta
```
